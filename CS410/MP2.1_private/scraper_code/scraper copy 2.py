...
thingClient = boto3.client('iot',aws_access_key_id='AKIAW4XVOTCPH3DUGNOD',aws_secret_access_key='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',region_name='us-east-2'
)
createThing()